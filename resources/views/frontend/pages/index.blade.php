        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($portfolios as $index => $portfolio)
                    @php
                        $link = Str::startsWith($portfolio->external_link, ['http://', 'https://']) 
                            ? $portfolio->external_link 
                            : 'https://' . $portfolio->external_link;
                    @endphp

                    <div class="col-lg-6 col-sm-6">
                        <div class="latest-portfolio-card tmp-hover-link tmp-scroll-trigger tmp-fade-in animation-order-{{ $index + 1 }}">
                            <div class="portfoli-card-img">
                                <div class="img-box v2">
                                    <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1" href="{{ $link }}" target="_blank">
                                        <img class="w-100" src="{{ asset($portfolio->portfolio_image) }}" alt="Thumbnail">
                                    </a>
                                </div>
                            </div>
                            <div class="portfolio-card-content-wrap">
                                <div class="content-left">
                                    <h3 class="portfolio-card-title">
                                        <a class="link" href="{{ $link }}" target="_blank">{{ $portfolio->title }}</a>
                                    </h3>
                                    <p class="portfoli-card-para">{{ $portfolio->category }}</p>
                                </div>
                                <a href="{{ $link }}" class="tmp-arrow-icon-btn" target="_blank">
                                    <div class="btn-inner">
