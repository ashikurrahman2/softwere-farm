    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="myLargeModalLabel">Add New Policy</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('policy.store')}}" method="post" id="add-form">
              @csrf
              ...
              <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control textarea" name="policy_description" id="summernote" rows="4" >{{old('policy_description')}}</textarea> 
                </div>
            </div>
...
// For Edit team 
    $('body').on('click', '.edit', function() {
        let id = $(this).data('id');
        $.get("policy/" + id + "/edit", function(data) {
