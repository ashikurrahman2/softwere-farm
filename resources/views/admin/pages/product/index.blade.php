    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="myLargeModalLabel">Add New Product</h5>
            ...
            <form action="{{route('product.store')}}" method="post" id="add-form" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div class="col-md-12">
                  ...
                  <input type="file" class="dropify" data-height="200" name="product_image"  required />
                  <small id="imageHelp" class="form-text text-muted">This is your Product image</small>
              </div>
